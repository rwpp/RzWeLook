...
type InteractiveServiceClient interface {
	...
	GetByIds(ctx context.Context, in *GetByIdRequest, opts ...grpc.CallOption) (*GetByIdResponse, error)
}
...
func (c *interactiveServiceClient) GetByIds(ctx context.Context, in *GetByIdRequest, opts ...grpc.CallOption) (*GetByIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type InteractiveServiceServer interface {
	...
	GetByIds(context.Context, *GetByIdRequest) (*GetByIdResponse, error)
...
func (UnimplementedInteractiveServiceServer) GetByIds(context.Context, *GetByIdRequest) (*GetByIdResponse, error) {
...
func _InteractiveService_GetByIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InteractiveServiceServer).GetByIds(ctx, req.(*GetByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
