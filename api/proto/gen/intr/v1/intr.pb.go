...
const file_intr_v1_intr_proto_rawDesc = "" +
	...
	"\abiz_ids\x18\x02 \x03(\x03R\x06bizIds\"\x9c\x01\n" +
	"\x0fGetByIdResponse\x129\n" +
	"\x05intrs\x18\x01 \x03(\v2#.intr.v1.GetByIdResponse.IntrsEntryR\x05intrs\x1aN\n" +
	"\n" +
	"IntrsEntry\x12\x10\n" +
	...
	"\x13IncrReadCntResponse2\x89\x03\n" +
	...
	"\bGetByIds\x12\x17.intr.v1.GetByIdRequest\x1a\x18.intr.v1.GetByIdResponseB\x8c\x01\n" +
	"\vcom.intr.v1B\tIntrProtoP\x01Z5github.com/rwpp/RzWeLook/api/proto/gen/intr/v1;intrv1\xa2\x02\x03IXX\xaa\x02\aIntr.V1\xca\x02\aIntr\\V1\xe2\x02\x13Intr\\V1\\GPBMetadata\xea\x02\bIntr::V1b\x06proto3"
